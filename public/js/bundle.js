...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"registerUser.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createClient.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createClient = exports.addCarToClient = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var createClient = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fname, lname, phone, email, address, city, postalCode) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Client créé avec succès !");
            // window.setTimeout(() => {
            //     location.assign('/connexion');
            // }, 1500);
          }
  ...
  return function createClient(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
exports.createClient = createClient;
var addCarToClient = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(idClient, vehicleList) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "post",
            url: "/api/v1/users/clients/".concat(idClient),
            data: {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Véhicule ajouté avec succès !");
            // window.setTimeout(() => {
            //     location.assign('/connexion');
            // }, 1500);
          }
  ...
  return function addCarToClient(_x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}();
exports.addCarToClient = addCarToClient;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"operation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateOperation = exports.showOperation = exports.deleteOperation = exports.createOperation = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var createOperation = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, price, duration) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Opération créée avec succès !");
          }
          _context.next = 10;
          break;
        case 7:
  ...
  return function createOperation(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
exports.createOperation = createOperation;
var updateOperation = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, name, price, duration) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "patch",
            url: "/api/v1/operations/".concat(id),
            data: {
              name: name,
              price: price,
              duration: duration
        ...
        case 4:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Opération mise à jour avec succès !");
            window.setTimeout(function () {
  ...
  return function updateOperation(_x4, _x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteOperation = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          (0, _alert.showAlert)("success", "Opération supprimée avec succès !");
          window.setTimeout(function () {
            location.assign('/gererOperation');
          }, 1500);
          _context3.next = 11;
  ...
  return function deleteOperation(_x8) {
    return _ref3.apply(this, arguments);
  };
}();
exports.deleteOperation = deleteOperation;
var showOperation = /*#__PURE__*/function () {
  ...
  return function showOperation(_x9) {
...
var _registerUser = require("./registerUser.js");
var _updateSettings = require("./updateSettings.js");
var _createClient = require("./createClient.js");
...
var userDataForm = document.querySelector('.myAccountData');
var userPassForm = document.querySelector('.myAccountPassword');
var registerForm = document.querySelector('.createuser');
var createClientForm = document.querySelector('.createClient');
var createOperationForm = document.querySelector('.createoperation');
var manageOperation = document.querySelector('.manageOperation');
// VALUES
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    var fname = document.querySelector('.fname').value;
    var lname = document.querySelector('.lname').value;
    var username = document.querySelector('.fname').value + document.querySelector('.lname').value;
