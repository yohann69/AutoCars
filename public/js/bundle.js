...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fname, lname, email) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var userDataForm = document.querySelector('.myAccount');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateSettings.updateSettings)(form.fname, form.lname, form.email);
  });
}
if (registerForm) {
